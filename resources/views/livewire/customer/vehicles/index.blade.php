              ...
              @foreach ($vehicles as $vehicle)
                  <div
                      ...
                      <div class="text-center mb-4">
                          <div
                              class="w-16 h-16 bg-gradient-to-br from-blue-300 to-purple-400 rounded-full flex items-center justify-center mx-auto mb-2">
                      ...
                      <div class="flex justify-center space-x-4">
                          <a href="{{ route('customer.vehicles.edit', $vehicle->pivot->id) }}"
                              class="text-gray-400 hover:text-gray-600" wire:navigate>
