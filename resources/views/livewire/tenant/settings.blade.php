<div class="space-y-2">
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        @if ($url && !$editing)
            <div class="card bg-gradient-to-r from-blue-400 to-blue-600 text-white shadow-xl flex-1">
                <div class="card-body">
                    <h2 class="card-title text-center text-base-100 mb-8">Kartu QR Code</h2>
                    <div class="flex flex-col items-center gap-4 mb-4">
                        <div class="border-6 border-blue-300 shadow-lg rounded-xl overflow-hidden">
                            {!! QrCode::size(200)->margin(2)->generate($url) !!}
                        </div>
...
<script>
    window.addEventListener('download-qr', event => {
        const a = document.createElement('a');
        a.href = "data:image/png;base64," + event.detail[0].qr;
        a.download = event.detail[0].name;
        a.click();
    });
</script>
