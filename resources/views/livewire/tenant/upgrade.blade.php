<div>
    ...
    <div class="bg-gradient-to-r from-violet-500 via-purple-500 to-indigo-600 text-white py-8 mb-6 rounded-2xl">
        <div class="max-w-4xl mx-auto text-center px-4">
            ...
            <p class="text-xl md:text-2xl text-blue-100 mb-8">Dapatkan fitur premium dan kapasitas lebih besar untuk
                bisnis Anda</p>
        ...
        <div class="bg-gray-50 rounded-2xl p-8 mb-12">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Ya, Anda bisa downgrade paket kapan saja, perubahan akan berlaku di
                        periode billing berikutnya.</p>
                </div>
                <div>
                    <h3 class="font-semibold mb-2">Bagaimana cara pembayaran?</h3>
                    <p class="text-gray-600 text-sm">Pembayaran dilakukan secara otomatis via kartu kredit atau transfer
                        bank bulanan.</p>
                </div>
                <div>
                    <h3 class="font-semibold mb-2">Apakah ada diskon untuk pembayaran tahunan?</h3>
                    <p class="text-gray-600 text-sm">Ya, dapatkan diskon 20% untuk pembayaran tahunan pada paket
                        tertentu.</p>
                </div>
                <div>
                    <h3 class="font-semibold mb-2">Dukungan teknis 24/7?</h3>
                    <p class="text-gray-600 text-sm">Dukungan premium tersedia 24/7 via chat dan email untuk paket
                        tertentu.</p>
                </div>
            </div>
        </div>
