<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4">
    ...
    <div class="absolute inset-0 z-0 overflow-hidden">
        <!-- Floating Circles -->
        <div class="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-blue-200 opacity-20 blur-3xl animate-pulse"></div>
        <div class="absolute top-3/4 right-1/4 w-48 h-48 rounded-full bg-indigo-200 opacity-20 blur-3xl animate-pulse delay-1000"></div>
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full bg-purple-200 opacity-10 blur-3xl animate-pulse delay-2000"></div>
